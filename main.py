...
# # chat_model = pickle.load(open('model\health2.pkl','rb'))
...
# # Prediction function
# def get_predicted_value(patient_symptoms, svc, symptoms_dict, diseases_list):
#     # Initialize an input vector of zeros with the size of symptoms_dict
#     input_vector = np.zeros(len(symptoms_dict))
    
#     # Set the index corresponding to each symptom in the input_vector to 1
#     for item in patient_symptoms:
...
#     # Return the predicted disease from diseases_list
#     return diseases_list.get(prediction_index, "Disease not found")


# patient_symptoms = ['skin_rash', 'itching']
# predicted_disease = get_predicted_value(patient_symptoms, svc, symptoms_dict, diseases_list)
...
# medications = pd.read_excel(r'C:\\Users\\Mahendra\\Favorites\\health_03\\Medicine-Recommendation-System--main\\Medicine_description.xlsx')
...
description = pd.read_csv("description (1).csv")
medications = pd.read_csv('medications.csv')
diets = pd.read_csv("diets.csv")


# load model===========================================
svc = pickle.load(open('model//svc (1).pkl','rb'))
...
# Model Prediction function
def get_predicted_value(patient_symptoms):
    input_vector = np.zeros(len(symptoms_dict))  # Using the global symptoms_dict
    for item in patient_symptoms:
        input_vector[symptoms_dict[item]] = 1
    return diseases_list[svc.predict([input_vector])[0]]  # Using the global svc and diseases_list
